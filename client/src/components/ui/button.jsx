...
const buttonVariants = cva(
	'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-gray-300',
	{
		variants: {
			variant: {
				default: 'bg-gray-900 text-white shadow hover:bg-gray-800 dark:bg-blue-600 dark:text-white dark:hover:bg-blue-700',
				destructive: 'bg-red-500 text-white shadow-sm hover:bg-red-600 dark:bg-red-600 dark:text-white dark:hover:bg-red-700',
				outline:
					'border border-gray-200 bg-white text-gray-900 shadow-sm hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-700 dark:hover:text-white',
				...
				link: 'text-gray-900 underline-offset-4 hover:underline dark:text-blue-400',
			},
			size: {
